const CACHE='monday-money-move-membership-2';
const ASSETS=['./','./index.html','./privacy.html','./terms.html','./support.html','./membership.js?v=paid-2','./conversion-preview.js?v=paid-2'];
