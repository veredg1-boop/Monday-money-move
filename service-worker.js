const CACHE='monday-money-move-v7';
const ASSETS=['./','./index.html','./privacy.html','./terms.html','./support.html','./success.html','./manifest.webmanifest','./brand/app-icon-master.svg'];
